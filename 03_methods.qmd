...
This chapter describes the methods and procedures used to collect data on driver behavior and TPRS displacement. More details on the reasoning behind these decisions are available in an associated research report [@macfarlaneEffectivenessTemporaryPortable2026].
