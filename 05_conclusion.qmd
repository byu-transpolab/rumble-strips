...
This research was funded by the Utah Department of Transportation 
...
opinions, endorsements, or policies of UDOT or the U.S. Department of Transportation. 
...
```{r credit, echo=FALSE, message=FALSE, warning=FALSE}
library(CRediTas)

# CRediTas::template_create(authors = c("Gregory Macfarlane", "Grant Schultz", "Tyler Carruth", "Benjamin Hailstone"), file = "credit.csv")
crt <- readr::read_csv("credit.csv", show_col_types = FALSE)
```
